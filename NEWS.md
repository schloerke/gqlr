...
* Remove dependency on `pryr` package (which is being archived). Required functions (`modify_lang()`, `make_function()`, `unenclose()`, `substitute_q()`) have been copied into the package.
